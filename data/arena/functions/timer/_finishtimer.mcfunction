...
execute as @a run scoreboard players operation @s RC %= @s SIZE_TIME
...
execute as @a run scoreboard players operation @s RC %= @s SIZE_WEATHER
...
item replace entity @a weapon.offhand with minecraft:shield{display:{Name:'{"text":"Starter Shield","color":"#cccccc","bold":true,"italic":false}'},Damage:236} 1
